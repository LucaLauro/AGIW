...
def accettabili(val1, val2):
    ...
    if sim >39 and sim<51 and sim2<80 and sim2>50:
        print(sim)
        print(fuzz.token_set_ratio(val1,val2))
    return sim >39 and sim<51 and sim2<80 and sim2>50
...
#soglia da cambiare
#minimo sort 50, se sort tra 35 e 50 -> se set è maggiore di 70/80 allora va bene (spero non caghi errori) forse anche 50 ma devo fare i controlli e togliere parole più corte di 4 caratteri