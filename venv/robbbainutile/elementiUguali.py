# creo un dizionario dove ho come chiave un prodotto e come valore tutti i prodotti uguali, stessa cosa di csv to list ma con i dizionari al posto della lista
import json
import pandas as pd
